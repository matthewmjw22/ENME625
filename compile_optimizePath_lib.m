% Standalone code generation for optimizePath
...
cfg.GenerateComments = true; % make as readable as possible
cfg.MATLABSourceComments = true; % make as readable as possible
cfg.PreserveVariableNames = 'All'; % make as readable as possible
